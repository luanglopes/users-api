...
describe('CreateUser', () => {
  const makeSut = () => {
    ...
    const sut = new CreateUserService(createUserRepository, hashProvider)

    return { sut, createUserRepository, hashProvider }
  }
  ...
  it('should call repository to persist user', async () => {
    ...
    const repositoryCreateMethodSpy = jest.spyOn(createUserRepository, 'create')
  ...
  it('should encrypt password before persist', async () => {
    const { sut, createUserRepository, hashProvider } = makeSut()
  ...
  it('should return created user', async () => {
    ...
    repositoryCreateMethodSpy.mockImplementationOnce(() =>
